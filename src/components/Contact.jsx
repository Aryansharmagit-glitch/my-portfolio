      ...
      <>
         <div className="container contact" id="contact">
            ...
            <div className="contact-icon"
               ...
               <a href="https://github.com/Aryansharmagit-glitch" target="_blank" className="items">
                  < FaGithubSquare className="icons" />
               </a>

               <a href="https://www.linkedin.com/in/aryan-sharma-761647298/" target="_blank" className="items">
